...
from salofutura.models import Root

from salofutura.views.api import TemplateAPI
...
logger = logging.getLogger('salofutura')

def my_view(request):
    return {'project':'salofutura'}

@view_config(context=Root, renderer='salofutura:templates/saloform.pt', permission='view')
...
@view_config(context=Root, name="salofutura", renderer='salofutura:templates/salofutura.pt', permission='view')
